    ...
    public class GPUIPrototype : IEquatable<GPUIPrototype>
    {
        ...
        public override int GetHashCode()
        {
            ...
            if (prototypeType == GPUIPrototypeType.MeshAndMaterial && prototypeMesh != null && prototypeMaterials != null && prototypeMaterials[0] != null)
                return HashCode.Combine(prototypeMesh.GetHashCode(), prototypeMaterials[0].GetHashCode());
        ...
        public int GetKey()
        {
            ...
            if (prototypeType == GPUIPrototypeType.MeshAndMaterial && prototypeMesh != null && prototypeMaterials != null && prototypeMaterials[0] != null)
                return HashCode.Combine(prototypeMesh.GetInstanceID(), prototypeMaterials[0].GetInstanceID());
            return GetHashCode();
        }
