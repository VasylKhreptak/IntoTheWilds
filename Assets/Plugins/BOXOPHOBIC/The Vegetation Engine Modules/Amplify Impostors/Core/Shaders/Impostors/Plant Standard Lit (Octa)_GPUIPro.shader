...
Shader "GPUInstancerPro/BOXOPHOBIC/The Vegetation Engine/Impostors/Plant Standard Lit (Octa)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 WorldPosition4027_g75843 = worldPosOut99;
				float3 worldToObj4970_g75843 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(WorldPosition4027_g75843), 1 ) ).xyz;
				float3 VertexPosition3564_g75843 = worldToObj4970_g75843;
				half3 VertexPos40_g76291 = VertexPosition3564_g75843;
				...
				float3 WorldPosition_Shifted4972_g75843 = ( WorldPosition4027_g75843 - TVE_WorldOrigin );
				...
				float3 vertexToFrag4543_g75843 = temp_output_114_0_g76267;
				float3 ObjectPosition4422_g75843 = vertexToFrag4543_g75843;
				float3 ObjectPosition_Shifted4976_g75843 = ( ObjectPosition4422_g75843 - TVE_WorldOrigin );
				float3 lerpResult4934_g75843 = lerp( WorldPosition_Shifted4972_g75843 , ObjectPosition_Shifted4976_g75843 , _MotionPosition_10);
				float3 Motion_10_Position4923_g75843 = lerpResult4934_g75843;
				half3 Input_Position419_g75868 = Motion_10_Position4923_g75843;
				float Input_MotionScale287_g75868 = ( _MotionScale_10 + 0.2 );
				half NoiseTex_Tilling735_g75868 = TVE_NoiseTexTilling;
				float2 temp_output_597_0_g75868 = (( Input_Position419_g75868 * Input_MotionScale287_g75868 * NoiseTex_Tilling735_g75868 * 0.0075 )).xz;
				float2 temp_output_447_0_g75873 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4464_g75843 = temp_output_447_0_g75873;
				half2 Input_DirectionWS423_g75868 = Global_Wind_DirectionWS4464_g75843;
				float lerpResult128_g75869 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g75868 = _MotionSpeed_10;
				half Input_MotionVariation284_g75868 = 0.0;
				half Input_GlobalMeshVariation569_g75868 = 0.0;
				float temp_output_630_0_g75868 = ( ( ( lerpResult128_g75869 * Input_MotionSpeed62_g75868 ) + ( Input_MotionVariation284_g75868 * Input_GlobalMeshVariation569_g75868 ) ) * 0.03 );
				float temp_output_607_0_g75868 = frac( temp_output_630_0_g75868 );
				float4 lerpResult590_g75868 = lerp( SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g75868 + ( -Input_DirectionWS423_g75868 * temp_output_607_0_g75868 ) ), 0.0 ) , SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g75868 + ( -Input_DirectionWS423_g75868 * frac( ( temp_output_630_0_g75868 + 0.5 ) ) ) ), 0.0 ) , ( abs( ( temp_output_607_0_g75868 - 0.5 ) ) / 0.5 ));
				half4 Noise_Complex703_g75868 = lerpResult590_g75868;
				float2 temp_output_645_0_g75868 = ((Noise_Complex703_g75868).rg*2.0 + -1.0);
				float2 break650_g75868 = temp_output_645_0_g75868;
				float3 appendResult649_g75868 = (float3(break650_g75868.x , 0.0 , break650_g75868.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS4572_g75843 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g75868 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g76296 = Global_Noise_OS4572_g75843;
				float2 break448_g75873 = temp_output_447_0_g75873;
				float3 appendResult452_g75873 = (float3(break448_g75873.x , 0.0 , break448_g75873.y));
				half2 Global_Wind_DirectionOS4658_g75843 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g75873 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g76296 = Global_Wind_DirectionOS4658_g75843;
				float temp_output_84_0_g75844 = _LayerMotionValue;
				float temp_output_19_0_g75848 = TVE_MotionUsage[(int)temp_output_84_0_g75844];
				float4 temp_output_91_19_g75844 = TVE_MotionCoords;
				half2 UV94_g75844 = ( (temp_output_91_19_g75844).zw + ( (temp_output_91_19_g75844).xy * (ObjectPosition4422_g75843).xz ) );
				float4 tex2DArrayNode50_g75844 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_Linear_Clamp, UV94_g75844,temp_output_84_0_g75844, 0.0 );
				float4 temp_output_17_0_g75848 = tex2DArrayNode50_g75844;
				float4 temp_output_112_19_g75844 = TVE_MotionParams;
				float4 temp_output_3_0_g75848 = temp_output_112_19_g75844;
				float4 ifLocalVar18_g75848 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75848 >= 0.5 )
				ifLocalVar18_g75848 = temp_output_17_0_g75848;
				else
				ifLocalVar18_g75848 = temp_output_3_0_g75848;
				float4 lerpResult22_g75848 = lerp( temp_output_3_0_g75848 , temp_output_17_0_g75848 , temp_output_19_0_g75848);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75848 = lerpResult22_g75848;
				#else
				float4 staticSwitch24_g75848 = ifLocalVar18_g75848;
				#endif
				half4 Global_Motion_Params4344_g75843 = staticSwitch24_g75848;
				float4 break322_g75873 = Global_Motion_Params4344_g75843;
				float lerpResult457_g75873 = lerp( break322_g75873.z , TVE_WindEditor.z , TVE_WindEditor.w);
				float temp_output_459_0_g75873 = ( 1.0 - lerpResult457_g75873 );
				half Global_Wind_Power2223_g75843 = ( 1.0 - ( temp_output_459_0_g75873 * temp_output_459_0_g75873 ) );
				half Input_WindPower449_g76296 = Global_Wind_Power2223_g75843;
				...
				half Mesh_Height1524_g75843 = saturate( ( VertexPosition3564_g75843.y / _AI_Offset.y ) );
				half Input_MeshHeight388_g76296 = Mesh_Height1524_g75843;
				...
				half Motion_10_Amplitude2258_g75843 = _MotionAmplitude_10;
				half Input_BendingAmplitude376_g76296 = Motion_10_Amplitude2258_g75843;
				...
				float2 appendResult433_g75873 = (float2(break322_g75873.x , break322_g75873.y));
				float2 temp_output_436_0_g75873 = (appendResult433_g75873*2.0 + -1.0);
				float2 break441_g75873 = temp_output_436_0_g75873;
				float3 appendResult440_g75873 = (float3(break441_g75873.x , 0.0 , break441_g75873.y));
				half2 Global_React_DirectionOS4574_g75843 = (( mul( GetWorldToObjectMatrix(), float4( appendResult440_g75873 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_React_DirectionOS358_g76296 = Global_React_DirectionOS4574_g75843;
				...
				half Global_React_Mask66_g75843 = ( break322_g75873.w * break322_g75873.w * break322_g75873.w * break322_g75873.w );
				float Input_InteractionGlobalMask330_g76296 = Global_React_Mask66_g75843;
				...
				half3 Motion_10_Interaction216_g75843 = appendResult638_g76296;
				half3 Angle44_g76291 = Motion_10_Interaction216_g75843;
				...
				float3 Vertex_Motion_Object833_g75843 = ( VertexPosRotationAxis50_g76293 + ( VertexPosOtherAxis82_g76293 * cos( Angle44_g76293 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g76293 ) * sin( Angle44_g76293 ) ) );
				float temp_output_84_0_g75850 = _LayerVertexValue;
				float temp_output_19_0_g75854 = TVE_VertexUsage[(int)temp_output_84_0_g75850];
				float4 temp_output_94_19_g75850 = TVE_VertexCoords;
				half2 UV97_g75850 = ( (temp_output_94_19_g75850).zw + ( (temp_output_94_19_g75850).xy * (ObjectPosition4422_g75843).xz ) );
				float4 tex2DArrayNode50_g75850 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, UV97_g75850,temp_output_84_0_g75850, 0.0 );
				float4 temp_output_17_0_g75854 = tex2DArrayNode50_g75850;
				float4 temp_output_111_19_g75850 = TVE_VertexParams;
				float4 temp_output_3_0_g75854 = temp_output_111_19_g75850;
				float4 ifLocalVar18_g75854 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75854 >= 0.5 )
				ifLocalVar18_g75854 = temp_output_17_0_g75854;
				else
				ifLocalVar18_g75854 = temp_output_3_0_g75854;
				float4 lerpResult22_g75854 = lerp( temp_output_3_0_g75854 , temp_output_17_0_g75854 , temp_output_19_0_g75854);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75854 = lerpResult22_g75854;
				#else
				float4 staticSwitch24_g75854 = ifLocalVar18_g75854;
				#endif
				half4 Global_Vertex_Params4413_g75843 = staticSwitch24_g75854;
				float4 break322_g75872 = Global_Vertex_Params4413_g75843;
				half Global_Vertex_Size174_g75843 = saturate( break322_g75872.w );
				float lerpResult346_g75843 = lerp( 1.0 , Global_Vertex_Size174_g75843 , _GlobalSize);
				float3 appendResult3480_g75843 = (float3(lerpResult346_g75843 , lerpResult346_g75843 , lerpResult346_g75843));
				half3 Vertex_Size1741_g75843 = appendResult3480_g75843;
				float3 Vertex_SizeFade1740_g75843 = half3(1,1,1);
				half IsInitialized3811_g75843 = _IsInitialized;
				float3 lerpResult16_g76287 = lerp( float3(0,0,0) , ( ( ( Vertex_Motion_Object833_g75843 * Vertex_Size1741_g75843 * Vertex_SizeFade1740_g75843 ) - VertexPosition3564_g75843 ) * IsInitialized3811_g75843 ) , TVE_IsEnabled);
				float3 Final_VertexPosition890_g75843 = ( lerpResult16_g76287 + _DisableSRPBatcher );
				
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4543_g75843;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord10.w = 0;
				inputMesh.vertex.xyz += Final_VertexPosition890_g75843;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				half3 Main_Albedo_Raw4295_g75843 = o.Albedo;
				half3 Main_Albedo3817_g75843 = ( Main_Albedo_Raw4295_g75843 * (_ImpostorColor).rgb );
				half3 Tint_Noise_Color5005_g75843 = float3(1,1,1);
				float4 break3589_g75843 = output0;
				half Main_Mask_Occlusion3712_g75843 = break3589_g75843.g;
				float3 lerpResult4779_g75843 = lerp( (_VertexOcclusionColor).rgb , float3( 1,1,1 ) , Main_Mask_Occlusion3712_g75843);
				half3 Occlusion_Color4789_g75843 = lerpResult4779_g75843;
				half3 Main_Albedo_Tinted4791_g75843 = ( Main_Albedo3817_g75843 * Tint_Noise_Color5005_g75843 * Occlusion_Color4789_g75843 );
				float3 temp_output_3_0_g76289 = Main_Albedo_Tinted4791_g75843;
				float dotResult20_g76289 = dot( temp_output_3_0_g76289 , float3(0.2126,0.7152,0.0722) );
				half Main_Albedo_Grayscale3807_g75843 = dotResult20_g76289;
				float3 temp_cast_1 = (Main_Albedo_Grayscale3807_g75843).xxx;
				float temp_output_82_0_g75862 = _LayerColorsValue;
				float temp_output_19_0_g75866 = TVE_ColorsUsage[(int)temp_output_82_0_g75862];
				float4 temp_output_91_19_g75862 = TVE_ColorsCoords;
				float3 WorldPosition4027_g75843 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75843 = packedInput.ase_texcoord10.xyz;
				float3 ObjectPosition4422_g75843 = vertexToFrag4543_g75843;
				float3 lerpResult4478_g75843 = lerp( WorldPosition4027_g75843 , ObjectPosition4422_g75843 , _ColorsPositionMode);
				half2 UV94_g75862 = ( (temp_output_91_19_g75862).zw + ( (temp_output_91_19_g75862).xy * (lerpResult4478_g75843).xz ) );
				float4 tex2DArrayNode83_g75862 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g75862,temp_output_82_0_g75862, 0.0 );
				float4 temp_output_17_0_g75866 = tex2DArrayNode83_g75862;
				float4 temp_output_92_86_g75862 = TVE_ColorsParams;
				float4 temp_output_3_0_g75866 = temp_output_92_86_g75862;
				float4 ifLocalVar18_g75866 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75866 >= 0.5 )
				ifLocalVar18_g75866 = temp_output_17_0_g75866;
				else
				ifLocalVar18_g75866 = temp_output_3_0_g75866;
				float4 lerpResult22_g75866 = lerp( temp_output_3_0_g75866 , temp_output_17_0_g75866 , temp_output_19_0_g75866);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75866 = lerpResult22_g75866;
				#else
				float4 staticSwitch24_g75866 = ifLocalVar18_g75866;
				#endif
				half4 Global_Colors_Params4558_g75843 = staticSwitch24_g75866;
				float4 temp_output_346_0_g75875 = Global_Colors_Params4558_g75843;
				half Global_Colors_A1701_g75843 = saturate( (temp_output_346_0_g75875).w );
				half Colors_Influence3998_g75843 = Global_Colors_A1701_g75843;
				float temp_output_4814_0_g75843 = ( 1.0 - Colors_Influence3998_g75843 );
				float3 lerpResult4004_g75843 = lerp( Main_Albedo_Tinted4791_g75843 , temp_cast_1 , ( 1.0 - ( temp_output_4814_0_g75843 * temp_output_4814_0_g75843 ) ));
				half3 Global_Colors_RGB1700_g75843 = (temp_output_346_0_g75875).xyz;
				half3 Colors_RGB3856_g75843 = ( Global_Colors_RGB1700_g75843 * 4.594794 * _ColorsIntensityValue );
				half Main_Mask_Remap3609_g75843 = break3589_g75843.b;
				half Colors_Value4022_g75843 = ( Main_Mask_Remap3609_g75843 * _GlobalColors );
				float3 ObjectPosition_Shifted4976_g75843 = ( ObjectPosition4422_g75843 - TVE_WorldOrigin );
				half3 Input_Position167_g76305 = ObjectPosition_Shifted4976_g75843;
				float dotResult156_g76305 = dot( (Input_Position167_g76305).xz , float2( 12.9898,78.233 ) );
				half Global_DynamicMode4535_g75843 = _VertexDynamicMode;
				half Input_DynamicMode120_g76305 = Global_DynamicMode4535_g75843;
				float Postion_Random162_g76305 = ( sin( dotResult156_g76305 ) * ( 1.0 - Input_DynamicMode120_g76305 ) );
				half Main_Variation_Or_Metallic3607_g75843 = break3589_g75843.r;
				half Input_Variation124_g76305 = Main_Variation_Or_Metallic3607_g75843;
				...
				half Global_VariationMesh4531_g75843 = clampResult171_g76305;
				float lerpResult4092_g75843 = lerp( 1.0 , Global_VariationMesh4531_g75843 , _ColorsVariationValue);
				half Colors_Variation3999_g75843 = lerpResult4092_g75843;
				half Occlusion_Alpha4842_g75843 = _VertexOcclusionColor.a;
				float lerpResult5080_g75843 = lerp( Main_Mask_Occlusion3712_g75843 , ( 1.0 - Main_Mask_Occlusion3712_g75843 ) , _VertexOcclusionColorsMode);
				float lerpResult5078_g75843 = lerp( Occlusion_Alpha4842_g75843 , 1.0 , lerpResult5080_g75843);
				half Occlusion_Colors4856_g75843 = lerpResult5078_g75843;
				float3 temp_output_3_0_g76290 = ( Main_Albedo3817_g75843 * Tint_Noise_Color5005_g75843 );
				float dotResult20_g76290 = dot( temp_output_3_0_g76290 , float3(0.2126,0.7152,0.0722) );
				float clampResult4925_g75843 = clamp( saturate( ( dotResult20_g76290 * 5.0 ) ) , 0.2 , 1.0 );
				half Main_Albedo_Globals4847_g75843 = clampResult4925_g75843;
				float temp_output_7_0_g76280 = 0.1;
				float temp_output_10_0_g76280 = ( 0.2 - temp_output_7_0_g76280 );
				float lerpResult16_g76279 = lerp( 0.0 , saturate( ( ( ( Colors_Value4022_g75843 * Colors_Variation3999_g75843 * Colors_Influence3998_g75843 * Occlusion_Colors4856_g75843 * Main_Albedo_Globals4847_g75843 ) - temp_output_7_0_g76280 ) / ( temp_output_10_0_g76280 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult4007_g75843 = lerp( Main_Albedo_Tinted4791_g75843 , ( lerpResult4004_g75843 * Colors_RGB3856_g75843 ) , lerpResult16_g76279);
				half3 Blend_Albedo_Colored3711_g75843 = lerpResult4007_g75843;
				half3 Global_OverlayColor1758_g75843 = (TVE_OverlayColor).rgb;
				float temp_output_84_0_g75856 = _LayerExtrasValue;
				float temp_output_19_0_g75860 = TVE_ExtrasUsage[(int)temp_output_84_0_g75856];
				float4 temp_output_93_19_g75856 = TVE_ExtrasCoords;
				float3 lerpResult4483_g75843 = lerp( WorldPosition4027_g75843 , ObjectPosition4422_g75843 , _ExtrasPositionMode);
				half2 UV96_g75856 = ( (temp_output_93_19_g75856).zw + ( (temp_output_93_19_g75856).xy * (lerpResult4483_g75843).xz ) );
				float4 tex2DArrayNode48_g75856 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75856,temp_output_84_0_g75856, 0.0 );
				float4 temp_output_17_0_g75860 = tex2DArrayNode48_g75856;
				float4 temp_output_94_85_g75856 = TVE_ExtrasParams;
				float4 temp_output_3_0_g75860 = temp_output_94_85_g75856;
				float4 ifLocalVar18_g75860 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75860 >= 0.5 )
				ifLocalVar18_g75860 = temp_output_17_0_g75860;
				else
				ifLocalVar18_g75860 = temp_output_3_0_g75860;
				float4 lerpResult22_g75860 = lerp( temp_output_3_0_g75860 , temp_output_17_0_g75860 , temp_output_19_0_g75860);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75860 = lerpResult22_g75860;
				#else
				float4 staticSwitch24_g75860 = ifLocalVar18_g75860;
				#endif
				half4 Global_Extras_Params4559_g75843 = staticSwitch24_g75860;
				float4 break456_g76302 = Global_Extras_Params4559_g75843;
				half Global_Extras_Overlay156_g75843 = break456_g76302.z;
				float lerpResult3746_g75843 = lerp( 1.0 , Global_VariationMesh4531_g75843 , _OverlayVariationValue);
				half Overlay_Variation3739_g75843 = lerpResult3746_g75843;
				half Overlay_Value4803_g75843 = ( _GlobalOverlay * Global_Extras_Overlay156_g75843 * Overlay_Variation3739_g75843 );
				half3 World_Normal3638_g75843 = o.Normal;
				float lerpResult4683_g75843 = lerp( 1.0 , saturate( (World_Normal3638_g75843).y ) , _OverlayProjectionValue);
				half Overlay_Projection4636_g75843 = lerpResult4683_g75843;
				half Overlay_Shading4874_g75843 = Main_Albedo_Globals4847_g75843;
				float lerpResult5086_g75843 = lerp( Main_Mask_Occlusion3712_g75843 , ( 1.0 - Main_Mask_Occlusion3712_g75843 ) , _VertexOcclusionOverlayMode);
				float lerpResult5084_g75843 = lerp( Occlusion_Alpha4842_g75843 , 1.0 , lerpResult5086_g75843);
				half Occlusion_Overlay4860_g75843 = lerpResult5084_g75843;
				float temp_output_7_0_g76281 = 0.1;
				float temp_output_10_0_g76281 = ( 0.2 - temp_output_7_0_g76281 );
				half Overlay_Mask3762_g75843 = saturate( ( ( ( Overlay_Value4803_g75843 * Overlay_Projection4636_g75843 * Overlay_Shading4874_g75843 * Occlusion_Overlay4860_g75843 ) - temp_output_7_0_g76281 ) / ( temp_output_10_0_g76281 + 0.0001 ) ) );
				float3 lerpResult3875_g75843 = lerp( Blend_Albedo_Colored3711_g75843 , Global_OverlayColor1758_g75843 , Overlay_Mask3762_g75843);
				half3 Blend_Albedo_Overlay4100_g75843 = lerpResult3875_g75843;
				half Global_WetnessContrast4862_g75843 = TVE_WetnessContrast;
				half Global_Extras_Wetness305_g75843 = break456_g76302.y;
				half Wetnness_Value4824_g75843 = ( Global_Extras_Wetness305_g75843 * _GlobalWetness );
				float3 lerpResult4833_g75843 = lerp( Blend_Albedo_Overlay4100_g75843 , ( Blend_Albedo_Overlay4100_g75843 * Blend_Albedo_Overlay4100_g75843 ) , ( Global_WetnessContrast4862_g75843 * Wetnness_Value4824_g75843 ));
				half3 Blend_Albedo_Wetness4830_g75843 = lerpResult4833_g75843;
				float3 _Vector12 = float3(1,1,1);
				half3 Tint_Highlight_Color4905_g75843 = _Vector12;
				float3 temp_output_4907_0_g75843 = ( Blend_Albedo_Wetness4830_g75843 * Tint_Highlight_Color4905_g75843 );
				half3 Subsurface_Color3656_g75843 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Wetness4830_g75843 );
				half Global_Subsurface4111_g75843 = TVE_SubsurfaceValue;
				half Global_OverlaySubsurface4959_g75843 = TVE_OverlaySubsurface;
				float lerpResult4960_g75843 = lerp( 1.0 , Global_OverlaySubsurface4959_g75843 , Overlay_Value4803_g75843);
				half Overlay_Subsurface4962_g75843 = lerpResult4960_g75843;
				half Subsurface_Intensity3684_g75843 = ( _SubsurfaceValue * Global_Subsurface4111_g75843 * Overlay_Subsurface4962_g75843 );
				float lerpResult5069_g75843 = lerp( 1.0 , Main_Mask_Remap3609_g75843 , _SubsurfaceMaskValue);
				half Subsurface_Mask3666_g75843 = lerpResult5069_g75843;
				half3 MainLight_Direction4110_g75843 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( packedInput.interp00 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult3635_g75843 = normalize( ase_worldViewDir );
				float dotResult3631_g75843 = dot( -MainLight_Direction4110_g75843 , normalizeResult3635_g75843 );
				float saferPower3620_g75843 = abs( saturate( dotResult3631_g75843 ) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g75843 = 0.0;
				#else
				float staticSwitch3636_g75843 = ( pow( saferPower3620_g75843 , _SubsurfaceAngleValue ) * _SubsurfaceScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g75843 = staticSwitch3636_g75843;
				half3 Subsurface_Approximation3702_g75843 = ( Subsurface_Color3656_g75843 * Subsurface_Intensity3684_g75843 * Subsurface_Mask3666_g75843 * Mask_Subsurface_View3614_g75843 );
				half3 Blend_Albedo_Subsurface3874_g75843 = ( temp_output_4907_0_g75843 + Subsurface_Approximation3702_g75843 );
				half IsInitialized3811_g75843 = _IsInitialized;
				float3 lerpResult3815_g75843 = lerp( float3( 1,0,0 ) , Blend_Albedo_Subsurface3874_g75843 , IsInitialized3811_g75843);
				
				float3 temp_cast_10 = (( 0.04 * _render_specular )).xxx;
				
				float3 temp_cast_11 = (0.0).xxx;
				half3 Emissive_Color4947_g75843 = (_EmissiveColor).rgb;
				half3 Emissive_Texture4942_g75843 = (output1).rgb;
				half Global_Extras_Emissive4408_g75843 = break456_g76302.x;
				float lerpResult4417_g75843 = lerp( 1.0 , Global_Extras_Emissive4408_g75843 , _GlobalEmissive);
				half Emissive_Value4941_g75843 = ( ( lerpResult4417_g75843 * _EmissivePhaseValue ) - 1.0 );
				half3 Emissive_Mask5026_g75843 = saturate( ( Emissive_Texture4942_g75843 + Emissive_Value4941_g75843 ) );
				float3 temp_output_3_0_g76301 = ( Emissive_Color4947_g75843 * Emissive_Mask5026_g75843 );
				...
				#ifdef TVE_EMISSIVE
				float3 staticSwitch5070_g75843 = hdEmission22_g76301;
				#else
				float3 staticSwitch5070_g75843 = temp_cast_11;
				#endif
				half3 Final_Emissive4365_g75843 = staticSwitch5070_g75843;
				
				half Main_Mask_Smoothness3820_g75843 = break3589_g75843.a;
				half Main_Smoothness3838_g75843 = ( Main_Mask_Smoothness3820_g75843 * _ImpostorSmoothnessValue );
				float temp_output_4864_0_g75843 = ( 1.0 - Wetnness_Value4824_g75843 );
				half Blend_Smoothness_Wetness3898_g75843 = saturate( ( Main_Smoothness3838_g75843 + ( 1.0 - ( temp_output_4864_0_g75843 * temp_output_4864_0_g75843 ) ) ) );
				
				float temp_output_3577_0_g75843 = o.Alpha;
				float localCustomAlphaClipAlways4430_g75843 = ( temp_output_3577_0_g75843 );
				half Global_Extras_Alpha1033_g75843 = saturate( break456_g76302.w );
				float lerpResult4544_g75843 = lerp( 0.0 , Global_VariationMesh4531_g75843 , _AlphaVariationValue);
				half Global_Alpha_Variation4546_g75843 = lerpResult4544_g75843;
				float lerpResult4053_g75843 = lerp( 1.0 , ( ( Global_Extras_Alpha1033_g75843 - Global_Alpha_Variation4546_g75843 ) + 0.09 ) , _GlobalAlpha);
				half Alpha_Composite4102_g75843 = lerpResult4053_g75843;
				float Alpha4430_g75843 = Alpha_Composite4102_g75843;
				{
				clip(Alpha4430_g75843 - 0.1);
				}
				half Final_Alpha4955_g75843 = localCustomAlphaClipAlways4430_g75843;
				

				surfaceDescription.Albedo = lerpResult3815_g75843;
				o.Normal = World_Normal3638_g75843;
				...
				surfaceDescription.Emission = Final_Emissive4365_g75843;
				surfaceDescription.Smoothness = Blend_Smoothness_Wetness3898_g75843;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = Final_Alpha4955_g75843;
...
ENDHLSL
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4543_g75843;
			...
			)
			{
				...
				float4 temp_output_93_19_g75856 = TVE_ExtrasCoords;
				float3 WorldPosition4027_g75843 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75843 = packedInput.ase_texcoord5.xyz;
				float3 ObjectPosition4422_g75843 = vertexToFrag4543_g75843;
				float3 lerpResult4483_g75843 = lerp( WorldPosition4027_g75843 , ObjectPosition4422_g75843 , _ExtrasPositionMode);
				half2 UV96_g75856 = ( (temp_output_93_19_g75856).zw + ( (temp_output_93_19_g75856).xy * (lerpResult4483_g75843).xz ) );
				float4 tex2DArrayNode48_g75856 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75856,temp_output_84_0_g75856, 0.0 );
...
ENDHLSL
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord13.xyz = vertexToFrag4543_g75843;
			...
			)
			{
				...
				float4 temp_output_93_19_g75856 = TVE_ExtrasCoords;
				float3 WorldPosition4027_g75843 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75843 = packedInput.ase_texcoord13.xyz;
				float3 ObjectPosition4422_g75843 = vertexToFrag4543_g75843;
				float3 lerpResult4483_g75843 = lerp( WorldPosition4027_g75843 , ObjectPosition4422_g75843 , _ExtrasPositionMode);
				half2 UV96_g75856 = ( (temp_output_93_19_g75856).zw + ( (temp_output_93_19_g75856).xy * (lerpResult4483_g75843).xz ) );
				float4 tex2DArrayNode48_g75856 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75856,temp_output_84_0_g75856, 0.0 );
...
ENDHLSL
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag4543_g75843;
			...
			)
			{
				...
				float4 temp_output_91_19_g75862 = TVE_ColorsCoords;
				float3 WorldPosition4027_g75843 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75843 = packedInput.ase_texcoord11.xyz;
				float3 ObjectPosition4422_g75843 = vertexToFrag4543_g75843;
				float3 lerpResult4478_g75843 = lerp( WorldPosition4027_g75843 , ObjectPosition4422_g75843 , _ColorsPositionMode);
				half2 UV94_g75862 = ( (temp_output_91_19_g75862).zw + ( (temp_output_91_19_g75862).xy * (lerpResult4478_g75843).xz ) );
				float4 tex2DArrayNode83_g75862 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g75862,temp_output_82_0_g75862, 0.0 );
...
Node;AmplifyShaderEditor.AmplifyImpostorNode;99;-1408,-256;Inherit;False;9903;Octahedron;False;True;True;13;17;16;15;5;14;12;8;1;2;11;10;9;7;6;21;18;2;Specular;False;9;0;SAMPLER2D;;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;SAMPLER2D;;False;6;SAMPLER2D;;False;7;SAMPLER2D;;False;8;SAMPLERSTATE;;False;17;FLOAT4;8;FLOAT4;9;FLOAT4;10;FLOAT4;11;FLOAT4;12;FLOAT4;13;FLOAT4;14;FLOAT4;15;FLOAT3;0;FLOAT3;1;FLOAT3;2;FLOAT3;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT3;7;FLOAT3;16
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;402;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Forward;0;6;Forward;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelOne;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelTwo;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=Forward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;395;-592,-256;Float;False;True;-1;2;TVEShaderCoreGUI;0;14;BOXOPHOBIC/The Vegetation Engine/Impostors/Plant Standard Lit (Octa);4e5791d7c677cf540a160f0a09e2385a;True;GBuffer;0;0;GBuffer;27;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;4;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;ImpostorType=Octahedron;True;5;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;16;Material Type,InvertActionOnDeselection;4;0;Energy Conserving Specular,InvertActionOnDeselection;1;0;  Transmission,InvertActionOnDeselection;0;0;Surface Type;0;0;Alpha Cutoff;0;0;Receive Decals;0;0;Receives SSR;0;0;Specular AA;0;0;Specular Occlusion Mode;0;0;Distortion;0;0;Distortion Mode;0;0;Distortion Depth Test;0;0;Blend Preserves Specular;1;0;Fog;1;0;Draw Before Refraction;0;0;Refraction Model;0;0;0;7;True;True;True;True;True;False;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;398;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;ShadowCaster;0;3;ShadowCaster;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;396;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;SceneSelectionPass;0;1;SceneSelectionPass;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;397;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;META;0;2;META;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;400;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Motion Vectors;0;5;Motion Vectors;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;40;False;;255;False;;40;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;399;-592,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;DepthOnly;0;4;DepthOnly;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;405;-1664,-64;Inherit;True;Property;_Emissive;Impostor Emissive Map;4;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;385;-1024,-256;Inherit;False;Base Impostor;22;;75843;47a437226c28ea34bad309b04e5582cd;36,4954,0,4399,1,4400,1,4412,1,4410,1,4447,1,4010,1,3868,1,4338,1,4434,1,4539,1,4336,1,5016,1,4804,1,4920,0,4910,1,3881,1,4831,1,3891,1,4416,1,1745,1,3479,0,5004,0,4987,0,3707,1,4676,1,1742,0,3484,0,860,1,4909,1,2260,1,5014,1,4901,0,4894,1,4911,1,5074,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;4918;FLOAT;1;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;16;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;4555;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
Node;AmplifyShaderEditor.CommentaryNode;410;-1664,384;Inherit;False;1279.438;100;Features;0;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.FunctionNode;411;-576,512;Inherit;False;Compile All Shaders;-1;;76501;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;412;-768,512;Inherit;False;Compile Impostors;-1;;76502;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;413;-1664,512;Inherit;False;Define Impostor HD;-1;;76503;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;414;-1408,512;Inherit;False;Define Lighting Standard;136;;76504;116a5c57ec750cb4896f729a6748c509;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;415;-1152,512;Inherit;False;Define ShaderType Plant;138;;76505;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;408;-1152,-640;Inherit;False;Property;_RenderSpecular;Impostor Render Specular;19;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;409;-1408,-640;Half;False;Property;_RenderCoverage;Impostor Alpha To Mask;20;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
WireConnection;99;0;101;0
WireConnection;99;1;405;0
WireConnection;395;0;385;3597
WireConnection;395;1;385;3594
WireConnection;395;5;385;4119
WireConnection;395;6;385;4372
WireConnection;395;7;385;3598
WireConnection;395;9;385;3593
WireConnection;395;11;385;534
...
ASEEND*/
//CHKSM=8C65AB3D99BB13B449B005A8E990CD9A7BE0B870