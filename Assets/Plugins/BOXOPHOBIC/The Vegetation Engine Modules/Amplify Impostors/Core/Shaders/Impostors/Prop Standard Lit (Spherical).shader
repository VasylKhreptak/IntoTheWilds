...
Shader "BOXOPHOBIC/The Vegetation Engine/Impostors/Prop Standard Lit (Spherical)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag4543_g76506;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord7.xyz;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert( AttributesMesh inputMesh  )
			{
				...
				float3 temp_output_114_0_g76546 = staticSwitch14_g76548;
				float3 vertexToFrag4543_g76506 = temp_output_114_0_g76546;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag4543_g76506;
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 temp_output_91_19_g76525 = TVE_ColorsCoords;
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord2.xyz;
				float3 ObjectPosition4422_g76506 = vertexToFrag4543_g76506;
				float3 lerpResult4478_g76506 = lerp( WorldPosition4027_g76506 , ObjectPosition4422_g76506 , _ColorsPositionMode);
				half2 UV94_g76525 = ( (temp_output_91_19_g76525).zw + ( (temp_output_91_19_g76525).xy * (lerpResult4478_g76506).xz ) );
				float4 tex2DArrayNode83_g76525 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76525,temp_output_82_0_g76525, 0.0 );
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 temp_output_114_0_g76546 = staticSwitch14_g76548;
				float3 vertexToFrag4543_g76506 = temp_output_114_0_g76546;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag4543_g76506;
			...
			)
			{
				...
				float4 temp_output_91_19_g76525 = TVE_ColorsCoords;
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord8.xyz;
				float3 ObjectPosition4422_g76506 = vertexToFrag4543_g76506;
				float3 lerpResult4478_g76506 = lerp( WorldPosition4027_g76506 , ObjectPosition4422_g76506 , _ColorsPositionMode);
				half2 UV94_g76525 = ( (temp_output_91_19_g76525).zw + ( (temp_output_91_19_g76525).xy * (lerpResult4478_g76506).xz ) );
				float4 tex2DArrayNode83_g76525 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76525,temp_output_82_0_g76525, 0.0 );
...
Node;AmplifyShaderEditor.CommentaryNode;336;-1664,384;Inherit;False;1279.438;100;Features;0;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.FunctionNode;337;-576,512;Inherit;False;Compile All Shaders;-1;;76501;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;338;-768,512;Inherit;False;Compile Impostors;-1;;76502;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;339;-1664,512;Inherit;False;Define Impostor HD;-1;;76503;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;340;-1408,512;Inherit;False;Define Lighting Standard;136;;76504;116a5c57ec750cb4896f729a6748c509;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;334;-1152,-640;Inherit;False;Property;_RenderSpecular;Impostor Render Specular;19;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;335;-1408,-640;Half;False;Property;_RenderCoverage;Impostor Alpha To Mask;20;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;342;-1152,512;Inherit;False;Define ShaderType Prop;138;;76505;96e31a47d32deff49ba83d5b364f536d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;298;-1024,-256;Inherit;False;Base Impostor;22;;76506;47a437226c28ea34bad309b04e5582cd;36,4954,0,4399,1,4400,1,4412,1,4410,1,4447,0,4010,1,3868,1,4338,0,4434,0,4539,1,4336,1,5016,1,4804,1,4920,0,4910,1,3881,0,4831,1,3891,1,4416,1,1745,0,3479,0,5004,0,4987,0,3707,0,4676,1,1742,0,3484,0,860,0,4909,0,2260,1,5014,1,4901,0,4894,1,4911,1,5074,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;4918;FLOAT;1;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;16;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;4555;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
...
ASEEND*/
//CHKSM=A096DE1BDF5F0572FF983AC58C4374D6988BB0A1
