...
Shader "BOXOPHOBIC/The Vegetation Engine/Impostors/Prop Standard Lit (Hemi)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g76546 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g76546 = ( localObjectPosition_UNITY_MATRIX_M14_g76546 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g76546 = localObjectPosition_UNITY_MATRIX_M14_g76546;
				#endif
				half3 ObjectData20_g76548 = staticSwitch13_g76546;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4543_g76506;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord10.w = 0;
				inputMesh.vertex.xyz += Final_VertexPosition890_g76506;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord10.xyz;
				...
				float4 tex2DArrayNode83_g76525 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76525,temp_output_82_0_g76525, 0.0 );
				...
				half3 Colors_RGB3856_g76506 = ( Global_Colors_RGB1700_g76506 * 4.594794 * _ColorsIntensityValue );
				half Main_Mask_Remap3609_g76506 = break3589_g76506.b;
				half Colors_Value4022_g76506 = ( Main_Mask_Remap3609_g76506 * _GlobalColors );
				half Colors_Variation3999_g76506 = 1.0;
				...
				float4 tex2DArrayNode48_g76519 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g76519,temp_output_84_0_g76519, 0.0 );
				...
				float3 hdEmission22_g76572 = ASEGetEmissionHDRColor(temp_output_3_0_g76572,temp_output_15_0_g76572,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				#ifdef TVE_EMISSIVE
				float3 staticSwitch5070_g76506 = hdEmission22_g76572;
				#else
				float3 staticSwitch5070_g76506 = temp_cast_10;
				#endif
				...
				surfaceDescription.Albedo = lerpResult3815_g76506;
				o.Normal = World_Normal3638_g76506;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Final_Metallic3834_g76506;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Final_Emissive4365_g76506;
				surfaceDescription.Smoothness = Blend_Smoothness_Wetness3898_g76506;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = Final_Alpha4955_g76506;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert( AttributesMesh inputMesh  )
			{
				...
				float3 temp_output_114_0_g76546 = staticSwitch14_g76548;
				float3 vertexToFrag4543_g76506 = temp_output_114_0_g76546;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag4543_g76506;
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 temp_output_91_19_g76525 = TVE_ColorsCoords;
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord5.xyz;
				float3 ObjectPosition4422_g76506 = vertexToFrag4543_g76506;
				float3 lerpResult4478_g76506 = lerp( WorldPosition4027_g76506 , ObjectPosition4422_g76506 , _ColorsPositionMode);
				half2 UV94_g76525 = ( (temp_output_91_19_g76525).zw + ( (temp_output_91_19_g76525).xy * (lerpResult4478_g76506).xz ) );
				float4 tex2DArrayNode83_g76525 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76525,temp_output_82_0_g76525, 0.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 temp_output_114_0_g76546 = staticSwitch14_g76548;
				float3 vertexToFrag4543_g76506 = temp_output_114_0_g76546;
				outputPackedVaryingsMeshToPS.ase_texcoord13.xyz = vertexToFrag4543_g76506;
			...
			)
			{
				...
				float4 temp_output_93_19_g76519 = TVE_ExtrasCoords;
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord13.xyz;
				float3 ObjectPosition4422_g76506 = vertexToFrag4543_g76506;
				float3 lerpResult4483_g76506 = lerp( WorldPosition4027_g76506 , ObjectPosition4422_g76506 , _ExtrasPositionMode);
				half2 UV96_g76519 = ( (temp_output_93_19_g76519).zw + ( (temp_output_93_19_g76519).xy * (lerpResult4483_g76506).xz ) );
				float4 tex2DArrayNode48_g76519 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g76519,temp_output_84_0_g76519, 0.0 );
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 temp_output_114_0_g76546 = staticSwitch14_g76548;
				float3 vertexToFrag4543_g76506 = temp_output_114_0_g76546;
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag4543_g76506;
			...
			)
			{
				...
				float4 temp_output_91_19_g76525 = TVE_ColorsCoords;
				float3 WorldPosition4027_g76506 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g76506 = packedInput.ase_texcoord11.xyz;
				float3 ObjectPosition4422_g76506 = vertexToFrag4543_g76506;
				float3 lerpResult4478_g76506 = lerp( WorldPosition4027_g76506 , ObjectPosition4422_g76506 , _ColorsPositionMode);
				half2 UV94_g76525 = ( (temp_output_91_19_g76525).zw + ( (temp_output_91_19_g76525).xy * (lerpResult4478_g76506).xz ) );
				float4 tex2DArrayNode83_g76525 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g76525,temp_output_82_0_g76525, 0.0 );
...
Node;AmplifyShaderEditor.AmplifyImpostorNode;99;-1408,-128;Inherit;False;9903;HemiOctahedron;False;True;True;15;17;16;14;5;13;12;8;1;2;11;10;9;7;6;21;18;2;Metallic;False;9;0;SAMPLER2D;;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;SAMPLER2D;;False;6;SAMPLER2D;;False;7;SAMPLER2D;;False;8;SAMPLERSTATE;;False;17;FLOAT4;8;FLOAT4;9;FLOAT4;10;FLOAT4;11;FLOAT4;12;FLOAT4;13;FLOAT4;14;FLOAT4;15;FLOAT3;0;FLOAT3;1;FLOAT3;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT3;7;FLOAT3;16
Node;AmplifyShaderEditor.CommentaryNode;300;-1664,-256;Inherit;False;1279.896;100;Final;6;328;327;326;331;329;325;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;325;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;SceneSelectionPass;0;1;SceneSelectionPass;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;329;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Motion Vectors;0;5;Motion Vectors;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;40;False;;255;False;;40;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;331;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Forward;0;6;Forward;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelOne;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelTwo;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=Forward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;326;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;META;0;2;META;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;324;-608,-128;Float;False;True;-1;2;TVEShaderCoreGUI;0;14;BOXOPHOBIC/The Vegetation Engine/Impostors/Prop Standard Lit (Hemi);4e5791d7c677cf540a160f0a09e2385a;True;GBuffer;0;0;GBuffer;27;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;4;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;ImpostorType=HemiOctahedron;True;5;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;1;LightMode=GBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;16;Material Type,InvertActionOnDeselection;0;0;Energy Conserving Specular,InvertActionOnDeselection;0;0;  Transmission,InvertActionOnDeselection;0;0;Surface Type;0;0;Alpha Cutoff;0;0;Receive Decals;0;0;Receives SSR;0;0;Specular AA;0;0;Specular Occlusion Mode;0;0;Distortion;0;0;Distortion Mode;0;0;Distortion Depth Test;0;0;Blend Preserves Specular;1;0;Fog;1;0;Draw Before Refraction;0;0;Refraction Model;0;0;0;7;True;True;True;True;True;False;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;327;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;ShadowCaster;0;3;ShadowCaster;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;328;-608,-256;Float;False;False;-1;2;ASEMaterialInspector;0;14;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;DepthOnly;0;4;DepthOnly;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.CommentaryNode;299;-1664,-640;Inherit;False;1282.438;100;Internal;0;;1,0.252,0,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;334;-1664,64;Inherit;True;Property;_Emissive;Impostor Emissive Map;4;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;340;-1152,-512;Inherit;False;Property;_RenderSpecular;Impostor Render Specular;19;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;341;-1408,-512;Half;False;Property;_RenderCoverage;Impostor Alpha To Mask;20;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;342;-1664,512;Inherit;False;1279.438;100;Features;0;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.FunctionNode;343;-576,640;Inherit;False;Compile All Shaders;-1;;76501;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;344;-768,640;Inherit;False;Compile Impostors;-1;;76502;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;345;-1664,640;Inherit;False;Define Impostor HD;-1;;76503;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;348;-1408,640;Inherit;False;Define Lighting Standard;136;;76504;116a5c57ec750cb4896f729a6748c509;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;350;-1152,640;Inherit;False;Define ShaderType Prop;138;;76505;96e31a47d32deff49ba83d5b364f536d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;338;-1024,-128;Inherit;False;Base Impostor;22;;76506;47a437226c28ea34bad309b04e5582cd;36,4954,0,4399,1,4400,1,4412,1,4410,1,4447,0,4010,1,3868,1,4338,0,4434,0,4539,1,4336,1,5016,1,4804,1,4920,0,4910,1,3881,0,4831,1,3891,1,4416,1,1745,0,3479,0,5004,0,4987,0,3707,0,4676,1,1742,0,3484,0,860,0,4909,0,2260,1,5014,1,4901,0,4894,1,4911,1,5074,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;4918;FLOAT;1;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;16;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;4555;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
WireConnection;99;0;101;0
WireConnection;99;1;334;0
WireConnection;324;0;338;3597
WireConnection;324;1;338;3594
WireConnection;324;4;338;3595
WireConnection;324;6;338;4372
WireConnection;324;7;338;3598
WireConnection;324;9;338;3593
WireConnection;324;11;338;534
...
ASEEND*/
//CHKSM=52BEDEF80E96DD312472D2028E7E9B93D69D540F
