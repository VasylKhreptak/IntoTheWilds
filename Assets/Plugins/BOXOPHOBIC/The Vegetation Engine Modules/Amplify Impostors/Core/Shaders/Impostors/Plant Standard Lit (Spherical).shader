	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float3 WorldPosition4027_g75759 = worldPosOut99;
				float3 worldToObj4970_g75759 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(WorldPosition4027_g75759), 1 ) ).xyz;
				float3 VertexPosition3564_g75759 = worldToObj4970_g75759;
				half3 VertexPos40_g76291 = VertexPosition3564_g75759;
				...
				float3 WorldPosition_Shifted4972_g75759 = ( WorldPosition4027_g75759 - TVE_WorldOrigin );
				...
				float3 vertexToFrag4543_g75759 = temp_output_114_0_g76267;
				float3 ObjectPosition4422_g75759 = vertexToFrag4543_g75759;
				float3 ObjectPosition_Shifted4976_g75759 = ( ObjectPosition4422_g75759 - TVE_WorldOrigin );
				float3 lerpResult4934_g75759 = lerp( WorldPosition_Shifted4972_g75759 , ObjectPosition_Shifted4976_g75759 , _MotionPosition_10);
				float3 Motion_10_Position4923_g75759 = lerpResult4934_g75759;
				half3 Input_Position419_g75784 = Motion_10_Position4923_g75759;
				float Input_MotionScale287_g75784 = ( _MotionScale_10 + 0.2 );
				half NoiseTex_Tilling735_g75784 = TVE_NoiseTexTilling;
				float2 temp_output_597_0_g75784 = (( Input_Position419_g75784 * Input_MotionScale287_g75784 * NoiseTex_Tilling735_g75784 * 0.0075 )).xz;
				float2 temp_output_447_0_g75789 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4464_g75759 = temp_output_447_0_g75789;
				half2 Input_DirectionWS423_g75784 = Global_Wind_DirectionWS4464_g75759;
				float lerpResult128_g75785 = lerp( _TimeParameters.x , ( ( _TimeParameters.x * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				half Input_MotionSpeed62_g75784 = _MotionSpeed_10;
				half Input_MotionVariation284_g75784 = 0.0;
				half Input_GlobalMeshVariation569_g75784 = 0.0;
				float temp_output_630_0_g75784 = ( ( ( lerpResult128_g75785 * Input_MotionSpeed62_g75784 ) + ( Input_MotionVariation284_g75784 * Input_GlobalMeshVariation569_g75784 ) ) * 0.03 );
				float temp_output_607_0_g75784 = frac( temp_output_630_0_g75784 );
				float4 lerpResult590_g75784 = lerp( tex2Dlod( TVE_NoiseTex, float4( ( temp_output_597_0_g75784 + ( -Input_DirectionWS423_g75784 * temp_output_607_0_g75784 ) ), 0, 0.0) ) , tex2Dlod( TVE_NoiseTex, float4( ( temp_output_597_0_g75784 + ( -Input_DirectionWS423_g75784 * frac( ( temp_output_630_0_g75784 + 0.5 ) ) ) ), 0, 0.0) ) , ( abs( ( temp_output_607_0_g75784 - 0.5 ) ) / 0.5 ));
				half4 Noise_Complex703_g75784 = lerpResult590_g75784;
				float2 temp_output_645_0_g75784 = ((Noise_Complex703_g75784).rg*2.0 + -1.0);
				float2 break650_g75784 = temp_output_645_0_g75784;
				float3 appendResult649_g75784 = (float3(break650_g75784.x , 0.0 , break650_g75784.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS4572_g75759 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g75784 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g76296 = Global_Noise_OS4572_g75759;
				float2 break448_g75789 = temp_output_447_0_g75789;
				float3 appendResult452_g75789 = (float3(break448_g75789.x , 0.0 , break448_g75789.y));
				half2 Global_Wind_DirectionOS4658_g75759 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g75789 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g76296 = Global_Wind_DirectionOS4658_g75759;
				float temp_output_84_0_g75760 = _LayerMotionValue;
				float temp_output_19_0_g75764 = TVE_MotionUsage[(int)temp_output_84_0_g75760];
				float4 temp_output_91_19_g75760 = TVE_MotionCoords;
				half2 UV94_g75760 = ( (temp_output_91_19_g75760).zw + ( (temp_output_91_19_g75760).xy * (ObjectPosition4422_g75759).xz ) );
				float4 tex2DArrayNode50_g75760 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_Linear_Clamp, UV94_g75760,temp_output_84_0_g75760, 0.0 );
				float4 temp_output_17_0_g75764 = tex2DArrayNode50_g75760;
				float4 temp_output_112_19_g75760 = TVE_MotionParams;
				float4 temp_output_3_0_g75764 = temp_output_112_19_g75760;
				float4 ifLocalVar18_g75764 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75764 >= 0.5 )
				ifLocalVar18_g75764 = temp_output_17_0_g75764;
				else
				ifLocalVar18_g75764 = temp_output_3_0_g75764;
				float4 lerpResult22_g75764 = lerp( temp_output_3_0_g75764 , temp_output_17_0_g75764 , temp_output_19_0_g75764);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75764 = lerpResult22_g75764;
				#else
				float4 staticSwitch24_g75764 = ifLocalVar18_g75764;
				#endif
				half4 Global_Motion_Params4344_g75759 = staticSwitch24_g75764;
				float4 break322_g75789 = Global_Motion_Params4344_g75759;
				float lerpResult457_g75789 = lerp( break322_g75789.z , TVE_WindEditor.z , TVE_WindEditor.w);
				float temp_output_459_0_g75789 = ( 1.0 - lerpResult457_g75789 );
				half Global_Wind_Power2223_g75759 = ( 1.0 - ( temp_output_459_0_g75789 * temp_output_459_0_g75789 ) );
				half Input_WindPower449_g76296 = Global_Wind_Power2223_g75759;
				...
				half Mesh_Height1524_g75759 = saturate( ( VertexPosition3564_g75759.y / _AI_Offset.y ) );
				half Input_MeshHeight388_g76296 = Mesh_Height1524_g75759;
				...
				half Motion_10_Amplitude2258_g75759 = _MotionAmplitude_10;
				half Input_BendingAmplitude376_g76296 = Motion_10_Amplitude2258_g75759;
				...
				float2 appendResult433_g75789 = (float2(break322_g75789.x , break322_g75789.y));
				float2 temp_output_436_0_g75789 = (appendResult433_g75789*2.0 + -1.0);
				float2 break441_g75789 = temp_output_436_0_g75789;
				float3 appendResult440_g75789 = (float3(break441_g75789.x , 0.0 , break441_g75789.y));
				half2 Global_React_DirectionOS4574_g75759 = (( mul( GetWorldToObjectMatrix(), float4( appendResult440_g75789 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_React_DirectionOS358_g76296 = Global_React_DirectionOS4574_g75759;
				...
				half Global_React_Mask66_g75759 = ( break322_g75789.w * break322_g75789.w * break322_g75789.w * break322_g75789.w );
				float Input_InteractionGlobalMask330_g76296 = Global_React_Mask66_g75759;
				...
				half3 Motion_10_Interaction216_g75759 = appendResult638_g76296;
				half3 Angle44_g76291 = Motion_10_Interaction216_g75759;
				...
				float3 Vertex_Motion_Object833_g75759 = ( VertexPosRotationAxis50_g76293 + ( VertexPosOtherAxis82_g76293 * cos( Angle44_g76293 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g76293 ) * sin( Angle44_g76293 ) ) );
				float temp_output_84_0_g75766 = _LayerVertexValue;
				float temp_output_19_0_g75770 = TVE_VertexUsage[(int)temp_output_84_0_g75766];
				float4 temp_output_94_19_g75766 = TVE_VertexCoords;
				half2 UV97_g75766 = ( (temp_output_94_19_g75766).zw + ( (temp_output_94_19_g75766).xy * (ObjectPosition4422_g75759).xz ) );
				float4 tex2DArrayNode50_g75766 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, UV97_g75766,temp_output_84_0_g75766, 0.0 );
				float4 temp_output_17_0_g75770 = tex2DArrayNode50_g75766;
				float4 temp_output_111_19_g75766 = TVE_VertexParams;
				float4 temp_output_3_0_g75770 = temp_output_111_19_g75766;
				float4 ifLocalVar18_g75770 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75770 >= 0.5 )
				ifLocalVar18_g75770 = temp_output_17_0_g75770;
				else
				ifLocalVar18_g75770 = temp_output_3_0_g75770;
				float4 lerpResult22_g75770 = lerp( temp_output_3_0_g75770 , temp_output_17_0_g75770 , temp_output_19_0_g75770);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75770 = lerpResult22_g75770;
				#else
				float4 staticSwitch24_g75770 = ifLocalVar18_g75770;
				#endif
				half4 Global_Vertex_Params4413_g75759 = staticSwitch24_g75770;
				float4 break322_g75788 = Global_Vertex_Params4413_g75759;
				half Global_Vertex_Size174_g75759 = saturate( break322_g75788.w );
				float lerpResult346_g75759 = lerp( 1.0 , Global_Vertex_Size174_g75759 , _GlobalSize);
				float3 appendResult3480_g75759 = (float3(lerpResult346_g75759 , lerpResult346_g75759 , lerpResult346_g75759));
				half3 Vertex_Size1741_g75759 = appendResult3480_g75759;
				float3 Vertex_SizeFade1740_g75759 = half3(1,1,1);
				half IsInitialized3811_g75759 = _IsInitialized;
				float3 lerpResult16_g76287 = lerp( float3(0,0,0) , ( ( ( Vertex_Motion_Object833_g75759 * Vertex_Size1741_g75759 * Vertex_SizeFade1740_g75759 ) - VertexPosition3564_g75759 ) * IsInitialized3811_g75759 ) , TVE_IsEnabled);
				float3 Final_VertexPosition890_g75759 = ( lerpResult16_g76287 + _DisableSRPBatcher );
				
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag4543_g75759;
				
				
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = 0;
				inputMesh.vertex.xyz += Final_VertexPosition890_g75759;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				half3 Main_Albedo_Raw4295_g75759 = o.Albedo;
				half3 Main_Albedo3817_g75759 = ( Main_Albedo_Raw4295_g75759 * (_ImpostorColor).rgb );
				half3 Tint_Noise_Color5005_g75759 = float3(1,1,1);
				float4 break3589_g75759 = output0;
				half Main_Mask_Occlusion3712_g75759 = break3589_g75759.g;
				float3 lerpResult4779_g75759 = lerp( (_VertexOcclusionColor).rgb , float3( 1,1,1 ) , Main_Mask_Occlusion3712_g75759);
				half3 Occlusion_Color4789_g75759 = lerpResult4779_g75759;
				half3 Main_Albedo_Tinted4791_g75759 = ( Main_Albedo3817_g75759 * Tint_Noise_Color5005_g75759 * Occlusion_Color4789_g75759 );
				float3 temp_output_3_0_g76289 = Main_Albedo_Tinted4791_g75759;
				float dotResult20_g76289 = dot( temp_output_3_0_g76289 , float3(0.2126,0.7152,0.0722) );
				half Main_Albedo_Grayscale3807_g75759 = dotResult20_g76289;
				float3 temp_cast_1 = (Main_Albedo_Grayscale3807_g75759).xxx;
				float temp_output_82_0_g75778 = _LayerColorsValue;
				float temp_output_19_0_g75782 = TVE_ColorsUsage[(int)temp_output_82_0_g75778];
				float4 temp_output_91_19_g75778 = TVE_ColorsCoords;
				float3 WorldPosition4027_g75759 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75759 = packedInput.ase_texcoord7.xyz;
				float3 ObjectPosition4422_g75759 = vertexToFrag4543_g75759;
				float3 lerpResult4478_g75759 = lerp( WorldPosition4027_g75759 , ObjectPosition4422_g75759 , _ColorsPositionMode);
				half2 UV94_g75778 = ( (temp_output_91_19_g75778).zw + ( (temp_output_91_19_g75778).xy * (lerpResult4478_g75759).xz ) );
				float4 tex2DArrayNode83_g75778 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g75778,temp_output_82_0_g75778, 0.0 );
				float4 temp_output_17_0_g75782 = tex2DArrayNode83_g75778;
				float4 temp_output_92_86_g75778 = TVE_ColorsParams;
				float4 temp_output_3_0_g75782 = temp_output_92_86_g75778;
				float4 ifLocalVar18_g75782 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75782 >= 0.5 )
				ifLocalVar18_g75782 = temp_output_17_0_g75782;
				else
				ifLocalVar18_g75782 = temp_output_3_0_g75782;
				float4 lerpResult22_g75782 = lerp( temp_output_3_0_g75782 , temp_output_17_0_g75782 , temp_output_19_0_g75782);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75782 = lerpResult22_g75782;
				#else
				float4 staticSwitch24_g75782 = ifLocalVar18_g75782;
				#endif
				half4 Global_Colors_Params4558_g75759 = staticSwitch24_g75782;
				float4 temp_output_346_0_g75791 = Global_Colors_Params4558_g75759;
				half Global_Colors_A1701_g75759 = saturate( (temp_output_346_0_g75791).w );
				half Colors_Influence3998_g75759 = Global_Colors_A1701_g75759;
				float temp_output_4814_0_g75759 = ( 1.0 - Colors_Influence3998_g75759 );
				float3 lerpResult4004_g75759 = lerp( Main_Albedo_Tinted4791_g75759 , temp_cast_1 , ( 1.0 - ( temp_output_4814_0_g75759 * temp_output_4814_0_g75759 ) ));
				half3 Global_Colors_RGB1700_g75759 = (temp_output_346_0_g75791).xyz;
				half3 Colors_RGB3856_g75759 = ( Global_Colors_RGB1700_g75759 * 4.594794 * _ColorsIntensityValue );
				half Main_Mask_Remap3609_g75759 = break3589_g75759.b;
				half Colors_Value4022_g75759 = ( Main_Mask_Remap3609_g75759 * _GlobalColors );
				float3 ObjectPosition_Shifted4976_g75759 = ( ObjectPosition4422_g75759 - TVE_WorldOrigin );
				half3 Input_Position167_g76305 = ObjectPosition_Shifted4976_g75759;
				float dotResult156_g76305 = dot( (Input_Position167_g76305).xz , float2( 12.9898,78.233 ) );
				half Global_DynamicMode4535_g75759 = _VertexDynamicMode;
				half Input_DynamicMode120_g76305 = Global_DynamicMode4535_g75759;
				float Postion_Random162_g76305 = ( sin( dotResult156_g76305 ) * ( 1.0 - Input_DynamicMode120_g76305 ) );
				half Main_Variation_Or_Metallic3607_g75759 = break3589_g75759.r;
				half Input_Variation124_g76305 = Main_Variation_Or_Metallic3607_g75759;
				...
				half Global_VariationMesh4531_g75759 = clampResult171_g76305;
				float lerpResult4092_g75759 = lerp( 1.0 , Global_VariationMesh4531_g75759 , _ColorsVariationValue);
				half Colors_Variation3999_g75759 = lerpResult4092_g75759;
				half Occlusion_Alpha4842_g75759 = _VertexOcclusionColor.a;
				float lerpResult5080_g75759 = lerp( Main_Mask_Occlusion3712_g75759 , ( 1.0 - Main_Mask_Occlusion3712_g75759 ) , _VertexOcclusionColorsMode);
				float lerpResult5078_g75759 = lerp( Occlusion_Alpha4842_g75759 , 1.0 , lerpResult5080_g75759);
				half Occlusion_Colors4856_g75759 = lerpResult5078_g75759;
				float3 temp_output_3_0_g76290 = ( Main_Albedo3817_g75759 * Tint_Noise_Color5005_g75759 );
				float dotResult20_g76290 = dot( temp_output_3_0_g76290 , float3(0.2126,0.7152,0.0722) );
				float clampResult4925_g75759 = clamp( saturate( ( dotResult20_g76290 * 5.0 ) ) , 0.2 , 1.0 );
				half Main_Albedo_Globals4847_g75759 = clampResult4925_g75759;
				float temp_output_7_0_g76280 = 0.1;
				float temp_output_10_0_g76280 = ( 0.2 - temp_output_7_0_g76280 );
				float lerpResult16_g76279 = lerp( 0.0 , saturate( ( ( ( Colors_Value4022_g75759 * Colors_Variation3999_g75759 * Colors_Influence3998_g75759 * Occlusion_Colors4856_g75759 * Main_Albedo_Globals4847_g75759 ) - temp_output_7_0_g76280 ) / ( temp_output_10_0_g76280 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult4007_g75759 = lerp( Main_Albedo_Tinted4791_g75759 , ( lerpResult4004_g75759 * Colors_RGB3856_g75759 ) , lerpResult16_g76279);
				half3 Blend_Albedo_Colored3711_g75759 = lerpResult4007_g75759;
				half3 Global_OverlayColor1758_g75759 = (TVE_OverlayColor).rgb;
				float temp_output_84_0_g75772 = _LayerExtrasValue;
				float temp_output_19_0_g75776 = TVE_ExtrasUsage[(int)temp_output_84_0_g75772];
				float4 temp_output_93_19_g75772 = TVE_ExtrasCoords;
				float3 lerpResult4483_g75759 = lerp( WorldPosition4027_g75759 , ObjectPosition4422_g75759 , _ExtrasPositionMode);
				half2 UV96_g75772 = ( (temp_output_93_19_g75772).zw + ( (temp_output_93_19_g75772).xy * (lerpResult4483_g75759).xz ) );
				float4 tex2DArrayNode48_g75772 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75772,temp_output_84_0_g75772, 0.0 );
				float4 temp_output_17_0_g75776 = tex2DArrayNode48_g75772;
				float4 temp_output_94_85_g75772 = TVE_ExtrasParams;
				float4 temp_output_3_0_g75776 = temp_output_94_85_g75772;
				float4 ifLocalVar18_g75776 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g75776 >= 0.5 )
				ifLocalVar18_g75776 = temp_output_17_0_g75776;
				else
				ifLocalVar18_g75776 = temp_output_3_0_g75776;
				float4 lerpResult22_g75776 = lerp( temp_output_3_0_g75776 , temp_output_17_0_g75776 , temp_output_19_0_g75776);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g75776 = lerpResult22_g75776;
				#else
				float4 staticSwitch24_g75776 = ifLocalVar18_g75776;
				#endif
				half4 Global_Extras_Params4559_g75759 = staticSwitch24_g75776;
				float4 break456_g76302 = Global_Extras_Params4559_g75759;
				half Global_Extras_Overlay156_g75759 = break456_g76302.z;
				float lerpResult3746_g75759 = lerp( 1.0 , Global_VariationMesh4531_g75759 , _OverlayVariationValue);
				half Overlay_Variation3739_g75759 = lerpResult3746_g75759;
				half Overlay_Value4803_g75759 = ( _GlobalOverlay * Global_Extras_Overlay156_g75759 * Overlay_Variation3739_g75759 );
				half3 World_Normal3638_g75759 = o.Normal;
				float lerpResult4683_g75759 = lerp( 1.0 , saturate( (World_Normal3638_g75759).y ) , _OverlayProjectionValue);
				half Overlay_Projection4636_g75759 = lerpResult4683_g75759;
				half Overlay_Shading4874_g75759 = Main_Albedo_Globals4847_g75759;
				float lerpResult5086_g75759 = lerp( Main_Mask_Occlusion3712_g75759 , ( 1.0 - Main_Mask_Occlusion3712_g75759 ) , _VertexOcclusionOverlayMode);
				float lerpResult5084_g75759 = lerp( Occlusion_Alpha4842_g75759 , 1.0 , lerpResult5086_g75759);
				half Occlusion_Overlay4860_g75759 = lerpResult5084_g75759;
				float temp_output_7_0_g76281 = 0.1;
				float temp_output_10_0_g76281 = ( 0.2 - temp_output_7_0_g76281 );
				half Overlay_Mask3762_g75759 = saturate( ( ( ( Overlay_Value4803_g75759 * Overlay_Projection4636_g75759 * Overlay_Shading4874_g75759 * Occlusion_Overlay4860_g75759 ) - temp_output_7_0_g76281 ) / ( temp_output_10_0_g76281 + 0.0001 ) ) );
				float3 lerpResult3875_g75759 = lerp( Blend_Albedo_Colored3711_g75759 , Global_OverlayColor1758_g75759 , Overlay_Mask3762_g75759);
				half3 Blend_Albedo_Overlay4100_g75759 = lerpResult3875_g75759;
				half Global_WetnessContrast4862_g75759 = TVE_WetnessContrast;
				half Global_Extras_Wetness305_g75759 = break456_g76302.y;
				half Wetnness_Value4824_g75759 = ( Global_Extras_Wetness305_g75759 * _GlobalWetness );
				float3 lerpResult4833_g75759 = lerp( Blend_Albedo_Overlay4100_g75759 , ( Blend_Albedo_Overlay4100_g75759 * Blend_Albedo_Overlay4100_g75759 ) , ( Global_WetnessContrast4862_g75759 * Wetnness_Value4824_g75759 ));
				half3 Blend_Albedo_Wetness4830_g75759 = lerpResult4833_g75759;
				float3 _Vector12 = float3(1,1,1);
				half3 Tint_Highlight_Color4905_g75759 = _Vector12;
				float3 temp_output_4907_0_g75759 = ( Blend_Albedo_Wetness4830_g75759 * Tint_Highlight_Color4905_g75759 );
				half3 Subsurface_Color3656_g75759 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Wetness4830_g75759 );
				half Global_Subsurface4111_g75759 = TVE_SubsurfaceValue;
				half Global_OverlaySubsurface4959_g75759 = TVE_OverlaySubsurface;
				float lerpResult4960_g75759 = lerp( 1.0 , Global_OverlaySubsurface4959_g75759 , Overlay_Value4803_g75759);
				half Overlay_Subsurface4962_g75759 = lerpResult4960_g75759;
				half Subsurface_Intensity3684_g75759 = ( _SubsurfaceValue * Global_Subsurface4111_g75759 * Overlay_Subsurface4962_g75759 );
				float lerpResult5069_g75759 = lerp( 1.0 , Main_Mask_Remap3609_g75759 , _SubsurfaceMaskValue);
				half Subsurface_Mask3666_g75759 = lerpResult5069_g75759;
				half3 MainLight_Direction4110_g75759 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( packedInput.interp00 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult3635_g75759 = normalize( ase_worldViewDir );
				float dotResult3631_g75759 = dot( -MainLight_Direction4110_g75759 , normalizeResult3635_g75759 );
				float saferPower3620_g75759 = abs( saturate( dotResult3631_g75759 ) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g75759 = 0.0;
				#else
				float staticSwitch3636_g75759 = ( pow( saferPower3620_g75759 , _SubsurfaceAngleValue ) * _SubsurfaceScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g75759 = staticSwitch3636_g75759;
				half3 Subsurface_Approximation3702_g75759 = ( Subsurface_Color3656_g75759 * Subsurface_Intensity3684_g75759 * Subsurface_Mask3666_g75759 * Mask_Subsurface_View3614_g75759 );
				half3 Blend_Albedo_Subsurface3874_g75759 = ( temp_output_4907_0_g75759 + Subsurface_Approximation3702_g75759 );
				half IsInitialized3811_g75759 = _IsInitialized;
				float3 lerpResult3815_g75759 = lerp( float3( 1,0,0 ) , Blend_Albedo_Subsurface3874_g75759 , IsInitialized3811_g75759);
				
				float3 temp_cast_10 = (( 0.04 * _render_specular )).xxx;
				
				float3 temp_cast_11 = (0.0).xxx;
				half3 Emissive_Color4947_g75759 = (_EmissiveColor).rgb;
				half3 Emissive_Texture4942_g75759 = (output1).rgb;
				half Global_Extras_Emissive4408_g75759 = break456_g76302.x;
				float lerpResult4417_g75759 = lerp( 1.0 , Global_Extras_Emissive4408_g75759 , _GlobalEmissive);
				half Emissive_Value4941_g75759 = ( ( lerpResult4417_g75759 * _EmissivePhaseValue ) - 1.0 );
				half3 Emissive_Mask5026_g75759 = saturate( ( Emissive_Texture4942_g75759 + Emissive_Value4941_g75759 ) );
				float3 temp_output_3_0_g76301 = ( Emissive_Color4947_g75759 * Emissive_Mask5026_g75759 );
				...
				#ifdef TVE_EMISSIVE
				float3 staticSwitch5070_g75759 = hdEmission22_g76301;
				#else
				float3 staticSwitch5070_g75759 = temp_cast_11;
				#endif
				half3 Final_Emissive4365_g75759 = staticSwitch5070_g75759;
				
				half Main_Mask_Smoothness3820_g75759 = break3589_g75759.a;
				half Main_Smoothness3838_g75759 = ( Main_Mask_Smoothness3820_g75759 * _ImpostorSmoothnessValue );
				float temp_output_4864_0_g75759 = ( 1.0 - Wetnness_Value4824_g75759 );
				half Blend_Smoothness_Wetness3898_g75759 = saturate( ( Main_Smoothness3838_g75759 + ( 1.0 - ( temp_output_4864_0_g75759 * temp_output_4864_0_g75759 ) ) ) );
				
				float temp_output_3577_0_g75759 = o.Alpha;
				float localCustomAlphaClipAlways4430_g75759 = ( temp_output_3577_0_g75759 );
				half Global_Extras_Alpha1033_g75759 = saturate( break456_g76302.w );
				float lerpResult4544_g75759 = lerp( 0.0 , Global_VariationMesh4531_g75759 , _AlphaVariationValue);
				half Global_Alpha_Variation4546_g75759 = lerpResult4544_g75759;
				float lerpResult4053_g75759 = lerp( 1.0 , ( ( Global_Extras_Alpha1033_g75759 - Global_Alpha_Variation4546_g75759 ) + 0.09 ) , _GlobalAlpha);
				half Alpha_Composite4102_g75759 = lerpResult4053_g75759;
				float Alpha4430_g75759 = Alpha_Composite4102_g75759;
				{
				clip(Alpha4430_g75759 - 0.1);
				}
				half Final_Alpha4955_g75759 = localCustomAlphaClipAlways4430_g75759;
				

				surfaceDescription.Albedo = lerpResult3815_g75759;
				o.Normal = World_Normal3638_g75759;
				...
				surfaceDescription.Emission = Final_Emissive4365_g75759;
				surfaceDescription.Smoothness = Blend_Smoothness_Wetness3898_g75759;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = Final_Alpha4955_g75759;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag4543_g75759;
			...
			)
			{
				...
				float4 temp_output_93_19_g75772 = TVE_ExtrasCoords;
				float3 WorldPosition4027_g75759 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75759 = packedInput.ase_texcoord2.xyz;
				float3 ObjectPosition4422_g75759 = vertexToFrag4543_g75759;
				float3 lerpResult4483_g75759 = lerp( WorldPosition4027_g75759 , ObjectPosition4422_g75759 , _ExtrasPositionMode);
				half2 UV96_g75772 = ( (temp_output_93_19_g75772).zw + ( (temp_output_93_19_g75772).xy * (lerpResult4483_g75759).xz ) );
				float4 tex2DArrayNode48_g75772 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75772,temp_output_84_0_g75772, 0.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4543_g75759;
			...
			)
			{
				...
				float4 temp_output_93_19_g75772 = TVE_ExtrasCoords;
				float3 WorldPosition4027_g75759 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75759 = packedInput.ase_texcoord10.xyz;
				float3 ObjectPosition4422_g75759 = vertexToFrag4543_g75759;
				float3 lerpResult4483_g75759 = lerp( WorldPosition4027_g75759 , ObjectPosition4422_g75759 , _ExtrasPositionMode);
				half2 UV96_g75772 = ( (temp_output_93_19_g75772).zw + ( (temp_output_93_19_g75772).xy * (lerpResult4483_g75759).xz ) );
				float4 tex2DArrayNode48_g75772 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75772,temp_output_84_0_g75772, 0.0 );
		...
		Pass
        {
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag4543_g75759;
			...
			)
			{
				...
				float4 temp_output_91_19_g75778 = TVE_ColorsCoords;
				float3 WorldPosition4027_g75759 = GetAbsolutePositionWS( worldPos );
				float3 vertexToFrag4543_g75759 = packedInput.ase_texcoord8.xyz;
				float3 ObjectPosition4422_g75759 = vertexToFrag4543_g75759;
				float3 lerpResult4478_g75759 = lerp( WorldPosition4027_g75759 , ObjectPosition4422_g75759 , _ColorsPositionMode);
				half2 UV94_g75778 = ( (temp_output_91_19_g75778).zw + ( (temp_output_91_19_g75778).xy * (lerpResult4478_g75759).xz ) );
				float4 tex2DArrayNode83_g75778 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g75778,temp_output_82_0_g75778, 0.0 );
...
Node;AmplifyShaderEditor.FunctionNode;338;-1024,-256;Inherit;False;Base Impostor;22;;75759;47a437226c28ea34bad309b04e5582cd;36,4954,0,4399,1,4400,1,4412,1,4410,1,4447,1,4010,1,3868,1,4338,1,4434,1,4539,1,4336,1,5016,1,4804,1,4920,0,4910,1,3881,1,4831,1,3891,1,4416,1,1745,1,3479,0,5004,0,4987,0,3707,1,4676,1,1742,0,3484,0,860,1,4909,1,2260,1,5014,1,4901,0,4894,1,4911,1,5074,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;4918;FLOAT;1;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;16;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;4555;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
Node;AmplifyShaderEditor.CommentaryNode;339;-1664,384;Inherit;False;1279.438;100;Features;0;;0,1,0.5,1;0;0
Node;AmplifyShaderEditor.FunctionNode;340;-576,512;Inherit;False;Compile All Shaders;-1;;76501;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;341;-768,512;Inherit;False;Compile Impostors;-1;;76502;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;342;-1664,512;Inherit;False;Define Impostor HD;-1;;76503;4bfc56eb4c68eb8429d853b857b9fcbe;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;343;-1408,512;Inherit;False;Define Lighting Standard;136;;76504;116a5c57ec750cb4896f729a6748c509;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;344;-1152,512;Inherit;False;Define ShaderType Plant;138;;76505;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;336;-1152,-640;Inherit;False;Property;_RenderSpecular;Impostor Render Specular;19;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;337;-1408,-640;Half;False;Property;_RenderCoverage;Impostor Alpha To Mask;20;1;[Enum];Create;False;0;2;Off;0;On;1;0;True;0;False;0;0;0;0;0;1;FLOAT;0
WireConnection;99;0;101;0
WireConnection;99;1;333;0
WireConnection;323;0;338;3597
WireConnection;323;1;338;3594
WireConnection;323;5;338;4119
WireConnection;323;6;338;4372
WireConnection;323;7;338;3598
WireConnection;323;9;338;3593
WireConnection;323;11;338;534
...
ASEEND*/
//CHKSM=BFC4A1FA007D95E6B2B8D36E08946D77EC8CF9EC
