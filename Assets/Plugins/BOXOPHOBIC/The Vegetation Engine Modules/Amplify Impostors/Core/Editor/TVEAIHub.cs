...
namespace TheVegetationEngineImpostors
{
    public class TVEAIHub : EditorWindow
    {
        ...
        [MenuItem("Window/BOXOPHOBIC/The Vegetation Engine/Hub/Amplify Impostors", false, 1001)]
        ...
        void OnEnable()
        {
            ...
            autorunPath = assetFolder + "/Core/Editor/TVEAIHubAutoRun.cs";
            ...
            bannerText = "Amplify Impostors Module";
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Welcome to the Amplify Impostors Module for the Vegetation Engine! Choose the render pipeline used in your project to make the shaders compatible with the current pipeline!", MessageType.Info, true);
            ...
            {
                EditorGUILayout.HelpBox("The Amplify Impostors Module is installed for the " + pipelineCurrent + "! Use the additional setting below to restart the render pipeline setup.", MessageType.Info, true);
