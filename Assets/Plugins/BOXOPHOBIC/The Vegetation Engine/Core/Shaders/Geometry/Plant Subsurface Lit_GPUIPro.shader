...
Shader "GPUInstancerPro/BOXOPHOBIC/The Vegetation Engine/Geometry/Plant Subsurface Lit"
{
	Properties
	{
		...
		_SizeFadeStartValue("Size Fade Start", Range( 0 , 10000)) = 0
		_SizeFadeEndValue("Size Fade End", Range( 0 , 10000)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half3 Blend_Albedo_Tinted2808_g76557 = ( ( Blend_Albedo265_g76557 * Tint_Gradient_Color5769_g76557 * Tint_Noise_Color5770_g76557 * Occlusion_Color648_g76557 ) + Matcap_Color7428_g76557 );
...
ENDHLSL
		...
		Pass
        {
			...
			VertexOutput VertexFunction(VertexInput inputMesh  )
			{
				...
				o.ase_texcoord5.xyz = vertexToFrag3890_g76557;
				o.ase_texcoord6.xyz = vertexToFrag4224_g76557;
					...
					)
			{
				...
				float temp_output_19_0_g76577 = TVE_ExtrasUsage[(int)temp_output_84_0_g76573];
				float4 temp_output_93_19_g76573 = TVE_ExtrasCoords;
				float3 vertexToFrag3890_g76557 = packedInput.ase_texcoord5.xyz;
				float3 WorldPosition3905_g76557 = vertexToFrag3890_g76557;
				float3 vertexToFrag4224_g76557 = packedInput.ase_texcoord6.xyz;
				float3 ObjectPosition4223_g76557 = vertexToFrag4224_g76557;
				float3 lerpResult4827_g76557 = lerp( WorldPosition3905_g76557 , ObjectPosition4223_g76557 , _ExtrasPositionMode);
				half2 UV96_g76573 = ( (temp_output_93_19_g76573).zw + ( (temp_output_93_19_g76573).xy * (lerpResult4827_g76557).xz ) );
				float4 tex2DArrayNode48_g76573 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g76573,temp_output_84_0_g76573, 0.0 );
...
ASEEND*/
//CHKSM=FD18F8F0D4D05FA9F4BFD1ADCBD9DF0EAFF16AAA